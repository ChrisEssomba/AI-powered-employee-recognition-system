...
#   For augmented data
model = load_model("./model/model_augmented.keras")
...
end_time = time.time()
speed = (end_time - start_time) / len(X_test)  # Average time per sample
...
loss = binary_crossentropy(Y_test, y_pred_probs).numpy()
